...
if __name__ == '__main__':
    ...
    dqn.load_state_dict(torch.load(r".\logs\dqn_Snake-v0PyTorch_20x20\20221212-122608\ffdqn_50000episodes_10000.pth"))
    ...
    render_video(env, agent, r"test6.mp4", epsilon=0.0,debug = True)
